...
function [TouchA ,TouchB]= rn_TrialWiseNEWPlotRecalibrated_poly_unblocked_foll_RB_merged(epochdataRegisteredGazeA_poly_right,epochdataRegisteredGazeA_poly_left, epochdataTouchA,epochdataTouchB, ModifiedTrialSets, saving_dir)
