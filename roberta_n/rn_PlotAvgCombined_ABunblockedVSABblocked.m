function [] = rn_PlotAvgCombined_ABunblockedVSABblocked (FullStructure, FullStructure_unblocked,FullStructure_blocked,saving_dir)

comparison_TargetOnset_ABunblockedVSABblocked = 0;
% comparison_BIFR_ABunblockedVSABblocked = 0;
...
for a = 1:8
	...
	if  ~comparison_TargetOnset_ABunblockedVSABblocked 
		if a>=1 && a<=4
			write_out_figure(gcf, fullfile(saving_dir,'_AvgABunblockedVSABblocked_TimeRed_ObjectiveRightAlignedtoTargetOnset.pdf'))
		end
		if a>=5 && a<=8
			write_out_figure(gcf, fullfile(saving_dir,'_AvgAvgABunblockedVSABblocked_TimeRed_ObjectiveLeftAlignedtoTargetOnset.pdf'))
		end
	else
		if a>=1 && a<=4
			write_out_figure(gcf, fullfile(saving_dir,'_AvgAvgABunblockedVSABblocked_TimeRed_ObjectiveRightAlignedtoBIFR.pdf'))
		end
		if a>=5 && a<=8
			write_out_figure(gcf, fullfile(saving_dir,'_AvgAvgABunblockedVSABblocked_TimeRed_ObjectiveLeftAlignedtoBIFR.pdf'))
		end
