function [] = subject_bias_analysis_rp02(ProcessFirstOnly)
%clear variables;
...
switch CurrentAnalysisSetName
	...
	case {'PrimateNeurobiology2018DPZ'}
		...
		% to speed things up collect the selected sessions triallog files
...
ExcludeWildCardList = {'Stimuli', 'SCP-VIDEO-01-A', 'SCP-VIDEO-01-B','Exclude.', '201701', '201702', '2017030', '2017031', '20170404T163523', 'A_SM-InactiveVirusScanner', 'A_Test', 'TestA', 'TestB', 'B_Test', '_PARKING', '_TESTVERSIONS'};
