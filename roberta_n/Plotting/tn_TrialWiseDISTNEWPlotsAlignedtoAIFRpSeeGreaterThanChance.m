...
function [DistGazeATouchA, DistGazeATouchB, TimepointsTrialWise]= tn_TrialWiseDISTNEWPlotsAlignedtoAIFRpSeeGreaterThanChance(distGazeATouchA, distGazeATouchB,epochdataGazeATimepoints, ModifiedTrialSets, saving_dir, fileID)
...
%     end
 ...
 %       AIFRAlignedAIFRAVG.Type2401=AIFRrelativetoAIFR(TrialLists,:);
    end
  ...
  %  AIFRAlignedAIFRAVG.Type2401=vertcat(AIFRAlignedAIFRAVG.Type2401,AIFRrelativetoAIFR(TrialLists,:));
    end
    if counter==2 
   ...
   %     AIFRAlignedAIFRAVG.Type2402=AIFRrelativetoAIFR(TrialLists,:);
    end
    ...
    %AIFRAlignedAIFRAVG.Type2402=vertcat(AIFRAlignedAIFRAVG.Type2402,AIFRrelativetoAIFR(TrialLists,:));
    end
    if counter==3 
     ...
     %   AIFRAlignedAIFRAVG.Type2403=AIFRrelativetoAIFR(TrialLists,:);
    end
   ...
   % AIFRAlignedAIFRAVG.Type2403=vertcat(AIFRAlignedAIFRAVG.Type2403,AIFRrelativetoAIFR(TrialLists,:));
    end
...
%        AIFRAlignedAIFRAVG.Type2404=AIFRrelativetoAIFR(TrialLists,:);
    end
 ...
 %   AIFRAlignedAIFRAVG.Type2404=vertcat(AIFRAlignedAIFRAVG.Type2404,AIFRrelativetoAIFR(TrialLists,:));
    end
  ...
  %      AIFRAlignedAIFRAVG.Type2405=AIFRrelativetoAIFR(TrialLists,:);
    end
   ...
   % AIFRAlignedAIFRAVG.Type2405=vertcat(AIFRAlignedAIFRAVG.Type2405,AIFRrelativetoAIFR(TrialLists,:));
    end
    if counter==14
    ...
    %    AIFRAlignedAIFRAVG.Type2406=AIFRrelativetoAIFR(TrialLists,:);
    end
 ...
 %   AIFRAlignedAIFRAVG.Type2406=vertcat(AIFRAlignedAIFRAVG.Type2406,AIFRrelativetoAIFR(TrialLists,:));
    end
    if counter==15 
  ...
  %      AIFRAlignedAIFRAVG.Type2407=AIFRrelativetoAIFR(TrialLists,:);
    end
  ...
  %  AIFRAlignedAIFRAVG.Type2407=vertcat(AIFRAlignedAIFRAVG.Type2407,AIFRrelativetoAIFR(TrialLists,:));
    end
   ...
   %             AIFRAlignedAIFRAVG.Type2408(1,1:(size(AIFRAlignedAIFRAVG.Type2407,2)))=NaN;
         else 
    ...
    %        AIFRAlignedAIFRAVG.Type2408=AIFRrelativetoAIFR(TrialLists,:);
         end
    end
   ...
   % AIFRAlignedAIFRAVG.Type2408=vertcat(AIFRAlignedAIFRAVG.Type2408,AIFRrelativetoAIFR(TrialLists,:));
    end
    ...
    if counter>=1 && counter<=4 
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveRightTopAlignedtoAIFR.jpg']))
        
    end
    if counter>=5 && counter<=8 
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveRightCenterAlignedtoAIFR.jpg']))
        
    end
    if counter>=9 && counter<=12  
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveRightBottomAlignedtoAIFR.jpg']))
        
    end
    if counter>=13 && counter<=16 
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveLeftTopAlignedtoAIFR.jpg']))
        
    end
    if counter>=17 && counter<=20  
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveLeftCenterAlignedtoAIFR.jpg']))
        
    end
    if counter>=21 && counter<=24 
        saveas(gcf, fullfile(saving_dir,[fileID, '_XHighThanChancepSeeDiffbwGazeTouchTimeRed_ObjectiveLeftBottomAlignedtoAIFR.jpg']))
    end
end
