function [scores, FullStructure] = rn_StructureDataforPermTest_subset_foll(FullStructure_unblocked_pre, FullStructure_unblocked_first)
...
for a = 1 : 8
	...
	TrialLists_unblocked_A = FullStructure_unblocked_pre.A.(cur_fieldnames_unblocked_A_newconditon);
	tmp_TrialLists_unblocked_A = FullStructure_unblocked_first.A.(cur_fieldnames_unblocked_pre_A);
