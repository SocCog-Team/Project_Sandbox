function [scores, FullStructure] = rn_StructureDataforPermTest_DIST_switch(FullStructure_unblocked, FullStructure_unblocked_pre, FullStructure_unblocked_first)
...
for a = 1 : 8
   disp(['Processing condition: ', FullStructure_unblocked_pre_AA{a}]);
	...
	if (a==3) ||(a==7)
		cur_fieldnames_unblocked_AA_newconditon = FullStructure_unblocked_first_AA{a+1};
	else
