...
if counter==1
	...
	if counter>=5 && counter<=8
		write_out_figure(gcf, fullfile(saving_dir,'EuclDiffbwTouchTime_unblocked_prefirstfollowing_RB_Red_ObjectiveLeftAlignedtoOnset.pdf'))
