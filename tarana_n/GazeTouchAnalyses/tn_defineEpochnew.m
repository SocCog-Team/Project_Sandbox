...
% valid_gaze_datapoints=find(data_struct_extract.data(:,15)~=-32768);
    for indexer4= 1:size(TrialWiseData.timepoints,1)
        ...
        epochdata.TargetOnset.timepoints(indexer4,1:length(epochdata_idx))=(TrialWiseData.timepoints(indexer4,epochdata_idx)-(maintask_datastruct.report_struct.data(indexer4,maintask_datastruct.report_struct.cn.A_TargetOnsetTime_ms)))/1000;
