function []=MonkeyAvgRewardAcrossEarlyLateSessions()
...
EarlySessionsdltReward=AllSessionMetrics.coordination_metrics_table.data(EarlySessions,AllSessionMetrics.coordination_metrics_table.cn.playerReward_A); 
LateSessionsdltReward=AllSessionMetrics.coordination_metrics_table.data(LateSessions,AllSessionMetrics.coordination_metrics_table.cn.playerReward_A); 
...
ylabel ('Player A Reward', 'FontSize',15)
...
saveas(gcf, fullfile(saving_dir,'MonkeyRewardEarlyvsLateSession.jpg'));
%        
