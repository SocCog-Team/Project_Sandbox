...
for a = 1:8
	...
	if a>=1 && a<=4
		write_out_figure(gcf, fullfile(saving_dir,'_AvgTouchAunblockedprefollVSTouchAunblockedfirstfollBR_TimeRed_ObjectiveRightAlignedtoTargetOnset.pdf'))
	end
	if a>=5 && a<=8
		write_out_figure(gcf, fullfile(saving_dir,'_AvgTouchAunblockedprefollVSTouchAunblockedfirstfollBR_TimeRed_ObjectiveLeftAlignedtoTargetOnset.pdf'))
	end
